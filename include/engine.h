...
struct EngineOptions {
    ...
    fs::path nnue_weight_path  = fs::path(PROJECT_ROOT) / "nnue/weights/EXPERIMENT_stage2_continued__cirr_filt_25wdl-1800.bin"; // 1024_16_32_pairmul_screlu  output_buckets_25wdl_1000  768_128x
